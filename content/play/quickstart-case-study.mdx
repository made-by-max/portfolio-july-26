...
Auth0’s Quickstarts let developers quickly spin up a new application and add login and logout functionality, allowing them to learn the product by diving directly into the coding experience.
...
We performed moderated usability tests over Zoom with 6 developers across varying skill levels who had at least some experience using React. For the test we asked them to complete our React Quickstart guide. We found that, in general, expert-level developers were able to work through the Quickstart guide without assistance in about 15 minutes with only minor difficulties. Novice developers had more difficulty and often required a bit of guidance from our moderator. They were generally able to complete the Quickstart, but it took them closer to 30 minutes.
...
![Screenshot showing pre-populated code sample](https://miro.medium.com/v2/resize:fit:700/1*5ulnFZbasTHLzBMA1Q_Gpw.png)
...
![Screenshot showing instructions to log in](https://miro.medium.com/v2/resize:fit:700/1*eoTkQNFEIMIKmxSPI-RyoQ.png)
...
![Screenshot showing the choice between integrating an existing app or downloading a sample app](https://miro.medium.com/v2/resize:fit:700/1*Ivj5QoGzrwIuI7OvTEr3eQ.png)
...
![Screenshot showing instructions to enter URL information](https://miro.medium.com/v2/resize:fit:700/1*KY2scNXKwkP8p6tfvZWUtg.png)

Entering URLs required navigating between the Quickstart and the dashboard.

![Screenshot showing instructions to input information in the dashboard](https://miro.medium.com/v2/resize:fit:700/1*TIXZao0sIAVk3KATxsc5hg.png)
...
![Screenshot showing an example code sample](https://miro.medium.com/v2/resize:fit:700/1*cw8TYfktSxIsgWdSpXIZOA.png)
...
![Screenshot of the redesigned Quickstart](https://miro.medium.com/v2/resize:fit:700/1*ZE6sSTHdkawLxOkWhI9OxQ.png)
...
![Screenshot of the redesigned Quickstart, showing the complete code sample](https://miro.medium.com/v2/resize:fit:700/1*Vnd1NwZaGwgaN_RRbRnw1g.png)
...
![Screenshot showing the account creation step of the Quickstart](https://miro.medium.com/v2/resize:fit:700/1*Ncx3TBNkh356D4ax2g_bzA.png)
...
![Screenshot showing that URL information can be input directly from the Quickstart](https://miro.medium.com/v2/resize:fit:700/1*bp-cgmmMFDrJjRrH1Z3hpw.png)
...
![Screenshot showing the updated Quickstart design](https://miro.medium.com/v2/resize:fit:700/1*wdP4hsdFTu5qOdvSOIU1wg.png)
...
![Screenshot showing the updated Quickstart design with new branding elements](https://miro.medium.com/v2/resize:fit:700/1*Uuz80DMFKRSa3o-r1qMLrw.png)
...
*Originally posted on [Medium](https://medium.com/auth0-design/redesigning-the-auth0-quickstart-experience-32b15a2baabc).*
