...
date: "2026-06-04"
type: "project"
description: "What I learned building a design system with Claude Code"
image: "cover_srz58q"
buttons:
  - label: "Storybook"
...
After that was in place I wanted to set up my variables in Figma. I spent quite a while looking for plugins that would automatically setup my variables from a JSON file. They all required a specific JSON format and most of the ones I tried didn't specify the format and just gave a generic error message when it was wrong.
...
<Image publicId="wonky-toasts_loztid" alt="design system components with squished toast components" />
...
<Image publicId="figma_voqx8s" alt="A screenshot of the Figma-only results" />
...
<Image publicId="claude_vthn0v" alt="A screenshot of the Claude-only results" />

And finally I gave it the same prompt but also gave it access to the Figma design.
<Image publicId="claude_figma_hvvdac" alt="A screenshot of the Claude plus Figma results" />
