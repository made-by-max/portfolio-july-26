...
![](https://miro.medium.com/v2/resize:fit:720/format:webp/1*2i8iolOrmtBeTQDJFWbvHg.png)
...
![A screenshot of Auth0’s docs, showing a mismatch between the breadcrumbs and sidebar](https://miro.medium.com/v2/resize:fit:720/format:webp/1*hH3po_WFCNT2umVkMa1zdg.png)
...
![An illustration of the feature based navigation](https://miro.medium.com/v2/resize:fit:720/format:webp/1*1OU822yEBZDzBM0tSFIb9w.png)
...
![](https://miro.medium.com/v2/resize:fit:720/format:webp/1*tmzrWkzdGNfSN_x3dYzpyw.png)
