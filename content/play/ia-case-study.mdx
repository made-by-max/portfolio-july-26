...
## Redesigning the Information Architecture of the Auth0 Docs Site
...
![Auth0's developer documentation site](https://miro.medium.com/v2/resize:fit:720/format:webp/1*2i8iolOrmtBeTQDJFWbvHg.png)
...
![A screenshot of Auth0’s docs, showing that a section is missing from the sidebar navigation](https://miro.medium.com/v2/resize:fit:700/0*GQ0KVbRpz_gCVDpG)
...
![A screenshot of Auth0’s docs, showing a mismatch between the breadcrumbs and sidebar](https://miro.medium.com/v2/resize:fit:720/format:webp/1*dR8Rf8loUOvpzzTAKZ6oeA.png)
...
![A screenshot of Auth0’s docs, showing Universal Login as a top-level category in the breadcrumbs but nested under Login in the sidebar](https://miro.medium.com/v2/resize:fit:720/format:webp/1*hH3po_WFCNT2umVkMa1zdg.png)
...
![A screenshot of Auth0’s docs, showing a very long sidebar](https://miro.medium.com/v2/resize:fit:720/format:webp/1*9ZwNU08h88slwhCK2ND4KQ.png)
...
![The existing navigation](https://miro.medium.com/v2/resize:fit:720/format:webp/0*_rIITOjRxdFG7KvP)
...
![The updated navigation](https://miro.medium.com/v2/resize:fit:720/format:webp/0*IgcQhAMqgSSByl0t)
...
![An illustration of the task-based card sort](https://miro.medium.com/v2/resize:fit:720/format:webp/1*Xppclp-k-FMFQDxPAO_YZA.png)

Others grouped topics more around features, for example creating groups like authentication and integrations.

![An illustration of the feature-based card sort](https://miro.medium.com/v2/resize:fit:720/format:webp/1*KZ4S-LqryhJ_ZVtwco0FgA.png)
...
![An illustration of the task-based navigation](https://miro.medium.com/v2/resize:fit:720/format:webp/1*1OU822yEBZDzBM0tSFIb9w.png)
...
![An illustration of the feature-based navigation](https://miro.medium.com/v2/resize:fit:720/format:webp/1*J07WcKk1rIyLkPSL6Fm5gA.png)
...
![A screenshot of the get started sidebar](https://miro.medium.com/v2/resize:fit:720/format:webp/1*LBi8UwOYreTlafSW3VPz2A.png)


![A screenshot of the secure sidebar](https://miro.medium.com/v2/resize:fit:720/format:webp/1*yib94eGzDU8eKoIl6BdS5Q.png)

![A screenshot of another category in the redesigned sidebar navigation](https://miro.medium.com/v2/resize:fit:720/format:webp/1*tmzrWkzdGNfSN_x3dYzpyw.png)
...
While doing internal validation, I got some feedback that many of our features, like organizations or extensibility, could spread across multiple categories and that more advanced users might struggle to find all the information they need on those topics. I’ll continue to work to address these concerns and ensure our docs accommodate both new and advanced users.
...
*Originally posted on [Medium](https://medium.com/auth0-design/using-research-to-untangle-our-documentation-db610379519f).*
