...
description: "How learning database design improved my communication on cross-functional teams"
techStack:
  - name: "Supabase"
    icon: "supabase"
  - name: "SQL"
